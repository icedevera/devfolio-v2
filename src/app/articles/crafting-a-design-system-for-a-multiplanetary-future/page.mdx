...
export const article = {
  ...
  description:
    'This tutorial will guide you through the development process of creating a simple Rock Paper Scissors game in Ethereum using Chainlink VRF, Foundry and Next.js.',
}
